...
// separado do drizzle.config.ts raiz de propósito, pra core e calendar não competirem pela mesma
...
export default defineConfig({
  ...
  migrations: { schema: "calendar_migrations", table: "__drizzle_migrations" },
});
